...
#email
def enviar_email():
    corpo_email = f'Olá suporte do whatsapp!, meu numero de whatsapp foi banido injustamente! por meios ilegais!! Tenho provas que o meu numero foi banido injustamente!! O numero banido foi: {c}, o whatsapp esta cheio de falhas!, meu numero e uma prova disso. Banido de forma INJUSTA! E ninguém faz nada!. Segue as prints de ameaça que eu recebi. Links: '
